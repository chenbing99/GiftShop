	...
	<body>
			...
			<div class="header">
				<div class="hea_nav">
					...
					<ul>
						...
						<a href="${pageContext.request.contextPath}/gift/list2">
							<li>叮咚一下</li>
						</a>
						<a href="personal.jsp">
							<li>个人中心</li>
				...
				<div class="hea_right">
					<p>
						...
						<a class="login_btn">登录</a>|<a href="${pageContext.request.contextPath}/adminlogin.jsp">管理员登录</a>
					</p>
					<a href="shop_car.jsp">
						<p>
							<i class="iconfont">&#xe600;</i>
		...
		<div class="login_bg">
			<div class="login">
				...
				<form action="GiftShop/user/userlogin" method="post">
					<p class="list">
